-- SCRIPT REALIZAT IN INTREGIME DE FVR aka FLAVIAN
-- SHOP : https://discord.gg/YWuavmus5F
...
local locatii_texte = {
    ...
    [10] = {897.48126220704,-3163.005859375,-97.123588562012,"Apropiete de un checkpint pentru a merge in oras"}
}
